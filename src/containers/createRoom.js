    ...
    return (
     ...
     <div className="createRoomDiv">
       <img className="formLogo"src={icebreakersv8} alt="icebreakers logo"/>
        ...
        <input className="formInput" id="rname" name='room_name' value={this.state.room_name} onChange={this.handleChange} />
        <label className="formLabel">Password</label>
        <input className="formInput" id="pword" name='password' type='password' value={this.state.password} onChange={this.handleChange} />
        <label className="formLabel">Host Name</label>
        <input className="formInput" id="uname" name='username' type='text' value={this.state.username} onChange={this.handleChange} />
        <br></br>
        <button className="formBtn" type='submit'>Create your Room</button>
        </form>
      </div>
    )
  }
